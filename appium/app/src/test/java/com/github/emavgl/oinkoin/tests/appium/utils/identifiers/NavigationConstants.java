...
public class NavigationConstants {
    ...
    public static final String CATEGORIES_TAB_SELECTED_ID = "categories-tab-selected";
    public static final String SETTINGS_TAB_ID = "settings-tab";
    public static final String SETTINGS_TAB_SELECTED_ID = "settings-tab-selected";
