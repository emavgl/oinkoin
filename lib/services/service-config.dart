...
class ServiceConfig {
  ...
  /// Cache of per-currency [NumberFormat] instances keyed by decimal digit count.
  /// Populated lazily by [formatCurrencyAmount]; cleared whenever the global
  /// format is invalidated.
