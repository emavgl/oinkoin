            ...
            child: Column(
              children: <Widget>[
                ...
                new Container(
                    ...
                    children: <Widget>[
                      Flexible(
                          child: new Text("Clicking the button below you can send us a feedback email. Your feedback is very appreciated and will help us to grow!", style: _biggerFont,))
                    ],
                  )),
                Container(
                  child: Align(
