...
extension Localization on String {
  static var _translations = Translations("en_us") +
      ...
      } +
      {
        ...
        "de_de": "Währung für die Ausgaben",
      } +
      {
        "en_us": "Theme",
        "it_it": "Tema",
      ...
      } +
      {
        ...
        "de_de": "Themenauswahl für die App",
      } +
      {
        "en_us": "Export",
        "it_it": "Esporta",
      ...
      } +
      {
        ...
        "de_de": "Möchten Sie wirklich alle Daten löschen?",
      } +
      {
        "en_us": "Yes",
        "it_it": "Si",
      ...
      } +
      {
        ...
        "de_de": "Eine Sicherung aller Daten erstellen",
      } +
      {
        "en_us": "Restore Backup",
        "it_it": "Ripristino",
        "de_de": "Sicherung wiederherstellen",
      } +

      {
        "en_us": "Restore successful",
        "it_it": "Ripristino riusciuto",
        "de_de": "Wiederherstellung erfolgreich",
      } +
      {
      ...
      } +
      {
        ...
        "de_de": "Die Sicherung wurde jetzt wieder hergestellt",
      } +
      {
        ...
        "de_de": "Stellen Sie sicher die neuste App-Version zu nutzen. Ist dies der Fall, könnte die Sicherungsdatei beschädigt sein.",
      } +
      {
        "en_us": "Restore Backup",
        "it_it": "Ripristino",
...

      {
        ...
        "de_de": "Sicherung aus Datei wiederherstellen",
      } +
      {
      ...
      } +
      {
        ...
        "de_de": "Wiederkehrende Einträge ansehen oder löschen",
      } +
      {
        "en_us": "Customization",
        "it_it": "Preferenze",
      ...
      } +
      {
        ...
        "de_de": "Anzahl der Dezimalstellen auswählen",
      } +
      {
        "en_us": "Colors",
        "it_it": "Colori",
      ...
      } +
      {
        ...
        "de_de": "Grafische Einstellungen setzen",
      } +
      {
