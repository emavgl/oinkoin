...
sed -i "" 's/com.github.emavgl.piggybankdebug/com.github.emavgl.piggybank/' android/app/build.gradle
...
sed -i "" 's/com.github.emavgl.piggybank/com.github.emavgl.piggybankprodebug/' ./android/app/build.gradle
sed -i "" 's/isPremium = false/isPremium = true/'  ./lib/services/service-config.dart
flutter build apk --obfuscate --split-debug-info=./build-debug-files --split-per-abi
